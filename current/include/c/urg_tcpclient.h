...
#include <stdint.h>
  ...
  typedef struct
  {
    ...
    int32_t pushed_back; // for pushded back char
  ...
  /*!
    ...
    \retval -1 error
  */
  extern int32_t tcpclient_open(urg_tcpclient_t *cli,
                                const char *server_ip_str, int32_t port_num);
  ...
  */
  extern int32_t tcpclient_read(urg_tcpclient_t *cli,
  ...
  */
  extern int32_t tcpclient_write(urg_tcpclient_t *cli,
                                 const char *userbuf, int32_t req_size);

  //! \attention not implemented yet.
  extern int32_t tcpclient_error(urg_tcpclient_t *cli,
  ...
  /*!
    ...
    \return the number of data read, -1 when error.
  */
  extern int32_t tcpclient_readline(urg_tcpclient_t *cli,
