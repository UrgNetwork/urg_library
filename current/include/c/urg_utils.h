...
#include "urg_sensor.h"
   ...
   */
   ...
   /*!
     ...
     Example
     \code
     int32_t min_distance, max_distance;
   ...
   */
   extern void urg_step_min_max(const urg_t *urg, int32_t *min_step, int32_t *max_step);
   ...
   */
   extern int32_t urg_scan_usec(const urg_t *urg);
   ...
   */
   extern int32_t urg_max_data_size(const urg_t *urg);
   ...
   */
   extern double urg_index2rad(const urg_t *urg, int32_t index);
   ...
   */
   extern double urg_index2deg(const urg_t *urg, int32_t index);
   ...
   */
   extern int32_t urg_rad2index(const urg_t *urg, double radian);
   ...
   */
   extern int32_t urg_deg2index(const urg_t *urg, double degree);
   ...
   */
   extern int32_t urg_rad2step(const urg_t *urg, double radian);
   ...
   */
   extern int32_t urg_deg2step(const urg_t *urg, double degree);
   ...
   */
   extern double urg_step2rad(const urg_t *urg, int32_t step);
   ...
   */
   extern double urg_step2deg(const urg_t *urg, int32_t step);
   ...
   */
   extern int32_t urg_step2index(const urg_t *urg, int32_t step);
   ...
   */
   extern void urg_delay(int32_t delay_msec);
#ifdef __cplusplus
}
#endif
