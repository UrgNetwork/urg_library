...
#include "urg_tcpclient.h"
  ...
  */
  extern int32_t connection_open(urg_connection_t *connection,
  ...
  */
  extern int32_t connection_set_baudrate(urg_connection_t *connection, int32_t baudrate);
  ...
  */
  extern int32_t connection_write(urg_connection_t *connection,
  ...
  */
  extern int32_t connection_read(urg_connection_t *connection,
  ...
  */
  extern int32_t connection_readline(urg_connection_t *connection,
                                     char *data, int32_t max_size, int32_t timeout);
