...
static int32_t found_ports_size = 0;
...
{
    int32_t n = sizeof(search_base_names) / sizeof(search_base_names[0]);
    int32_t i;
...
int32_t urg_serial_find_port(void)
{
    int32_t n = sizeof(search_dir_names) / sizeof(search_dir_names[0]);
    int32_t i;
...
const char *urg_serial_port_name(int32_t index)
{
...
int32_t urg_serial_is_urg_port(int32_t index)
{
