...
struct Connection_information::pImpl
{
    ...
    int32_t baudrate_or_port_number_;
...
Connection_information::Connection_information(int32_t argc,
...
int32_t Connection_information::baudrate_or_port_number(void) const
{
